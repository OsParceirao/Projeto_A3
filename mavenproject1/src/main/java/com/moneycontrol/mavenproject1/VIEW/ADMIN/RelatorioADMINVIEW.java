...
public class RelatorioADMINVIEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(368, 6, 230, 43);
        ...
        jButton1.setBounds(730, 500, 100, 28);
        ...
        jButton2.setBounds(830, 500, 100, 28);
        ...
        jButton3.setBounds(610, 500, 120, 28);
        ...
        jButton4.setBounds(6, 502, 100, 28);
        ...
        jScrollPane2.setBounds(20, 150, 903, 339);
        ...
        pesquisaCursotextfieldVIEW.setBounds(290, 100, 640, 41);

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Nome da Despesa");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(6, 91, 300, 43);
        ...
        jLabel4.setBounds(0, -20, 940, 580);

        setSize(new java.awt.Dimension(954, 570));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        ExcluirDespesaADMINVIEW escluidespesaadminVIEW = new ExcluirDespesaADMINVIEW();
        escluidespesaadminVIEW.setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        EditDespesaADMINVIEW editdepsesaadminVIEW = new EditDespesaADMINVIEW();
        editdepsesaadminVIEW.setVisible(true);
